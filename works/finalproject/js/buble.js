...
var clrRange = [ "#E9967A" , "#BDB76B", "#DDA0DD", "#90EE90", "#DEB887", "#40E0D0","#B0E0E6"];
...
function mainBubblechart(data)
{
    ...
    // var legtxt = svg.selectAll("g").data(legend);
        
    // var enterLeg = leg.enter().append("g");

    // leg.merge(enterLeg).append("rect")
    //     .attr("y",height-20)
    //     .attr("x",function(d,i)
    //                     {
    //                         return i*100
    ...
    // leg.merge(enterLeg).append("text") 
